...
import com.voyager.nearbystores_v2.adapter.CountriesAutoCompleteAdapter;
...
import com.voyager.nearbystores_v2.utils.ImageUtils;
                    ...
                    if(success==1){
                        ...
                        if(list.size()>0){
                            ...
                            (new Handler()).postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    stopService(new Intent(SignupActivity.this, SocketService.class));
                                    startService(new Intent(SignupActivity.this, SocketService.class));
                                    finish();
                                }
                            },3000);
