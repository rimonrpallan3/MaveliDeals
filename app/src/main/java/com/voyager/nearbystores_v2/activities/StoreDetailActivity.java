...
import com.voyager.nearbystores_v2.controllers.SettingsController;
...
import com.voyager.nearbystores_v2.fragments.StoreOffersFragment;
import com.voyager.nearbystores_v2.fragments.StoreReviewsFragment;
...
import com.voyager.nearbystores_v2.unbescape.html.HtmlEscape;
...
import static com.voyager.nearbystores_v2.appconfig.AppConfig.BASE_URL;
import static com.voyager.nearbystores_v2.appconfig.AppConfig.SHOW_ADS;
import static com.voyager.nearbystores_v2.appconfig.AppConfig.SHOW_ADS_IN_STORE;
...
public class StoreDetailActivity extends AppCompatActivity implements ViewManager.CustomView,
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        try {
            ...
            System.out.println("StoreDetailActivity onCreate path: "+path);
        }catch (Exception e){
            e.printStackTrace();
        }
...
//        mapFrag.getMapAsync(this);
    ...
    private void putDataIntoViews() {
        ...
        distanceView.setText(
                Utils.preparDistance(storedata.getDistance())
                        +" "+
                Utils.getDistanceBy(storedata.getDistance()).toUpperCase()
        );
    ...
    private void doSave(final int user_id, final int store_id){
        ...
        saveBtn.setBackgroundColor(ResourcesCompat.getColor(getResources(),R.color.gray_field,null));
        unsaveBtn.setBackgroundColor(ResourcesCompat.getColor(getResources(),R.color.gray_field,null));
        ...
        SimpleRequest request = new SimpleRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                saveBtn.setBackgroundColor(ResourcesCompat.getColor(getResources(),R.color.colorPrimary,null));
                unsaveBtn.setBackgroundColor(ResourcesCompat.getColor(getResources(),R.color.colorPrimary,null));
