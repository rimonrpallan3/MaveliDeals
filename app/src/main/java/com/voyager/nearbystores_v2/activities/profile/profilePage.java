package com.voyager.nearbystores_v2.activities.profile;
...
public class ProfilePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(userDetails!=null){
            ...
            tvUserName.setText(userRow.getName());
            tvEmail.setText(userRow.getEmail());
            tvPhoneNo.setText(userRow.getMobile());
        }
