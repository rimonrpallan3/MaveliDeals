package com.voyager.nearbystores_v2.animation;
...
/**
 * Created by Amine on 9/24/2017.
 */

public class Animation {


    public static View startZoomEffectForRightMessage(final View view){
        ...
        ScaleAnimation scaleAnimation =
                new ScaleAnimation(0.8f, 1.0f, 0.8f, 1.0f, ScaleAnimation.RELATIVE_TO_SELF, 1.0f,
    ...
    public static View startZoomEffectForLeftMessage(final View view){
        ...
        ScaleAnimation scaleAnimation =
                new ScaleAnimation(0.8f, 1.0f, 0.8f, 1.0f, ScaleAnimation.RELATIVE_TO_SELF,0.0f,
    ...
    public static View displayWithZoomEffect(final View view){
        ...
        ScaleAnimation scaleAnimation =
                new ScaleAnimation(0.6f, 1.1f, 0.6f, 1.1f, ScaleAnimation.RELATIVE_TO_SELF, 0.5f,
                        ScaleAnimation.RELATIVE_TO_SELF, 0.5f);
