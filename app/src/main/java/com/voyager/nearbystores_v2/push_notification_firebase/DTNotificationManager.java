...
import com.voyager.nearbystores_v2.activities.StoreDetailActivity;
    ...
    public void push(){
        ...
        if(data.containsKey("type") && data.get("type").equals(Tags.NOTIFICATION)
         && AppConfig.CHAT_WITH_FIREBASE && AppConfig.ENABLE_CHAT){
            ...
            if(AppConfig.APP_DEBUG)
                Log.e("DTNotificationManager","Somthing wrong!");
...
//            if(notif_offers)
//                NotificationsManager.customView(context);
            ...
            if(notif_nearby_stores)
                NotificationUtils.sendNotification(context,mParser.getTitle(),context.getString(R.string.storeNearYou),icon,null, StoreDetailActivity.class,data);
            ...
            if(notif_nearby_events)
                NotificationUtils.sendNotification(context,mParser.getTitle(),context.getString(R.string.eventNearYou),icon,null, EventActivity.class,data);
