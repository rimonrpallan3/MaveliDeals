 ...
 * =============================================================================
 */
package com.voyager.nearbystores_v2.unbescape.css;
...
public final class CssEscape {
     ...
     * <p>
     *   This method calls
     *   {@link #escapeCssString(char[], int, int, Writer, CssStringEscapeType, CssStringEscapeLevel)}
     *   with the following preconfigured values:
     * </p>
     * <ul>
     *   <li><tt>type</tt>:
     ...
     * <p>
     *   This method calls
     *   {@link #escapeCssIdentifier(char[], int, int, Writer, CssIdentifierEscapeType, CssIdentifierEscapeLevel)}
     *   with the following preconfigured values:
     * </p>
     * <ul>
     *   <li><tt>type</tt>:
