 ...
 * =============================================================================
 */
package com.voyager.nearbystores_v2.unbescape.properties;
...
public final class PropertiesEscape {
     ...
     * </ul>
     * <p>
     *   This method calls {@link #escapePropertiesValue(char[], int, int, Writer, PropertiesValueEscapeLevel)}
     *   with the following preconfigured values:
     * </p>
     * <ul>
     *   <li><tt>level</tt>:
     ...
     * </ul>
     * <p>
     *   This method calls {@link #escapePropertiesKey(char[], int, int, Writer, PropertiesKeyEscapeLevel)}
     *   with the following preconfigured values:
     * </p>
     * <ul>
     *   <li><tt>level</tt>:
