 ...
 * =============================================================================
 */
package com.voyager.nearbystores_v2.unbescape.html;
...
final class HtmlEscapeSymbols {
     ...
     * - Approximate size will be 16 (header_layout) + 12287 * 2 = 24590 bytes.
     */
     ...
     *   16 (header_layout) + 138 * (16 (entry header_layout) + 16*2 (key, value headers) + 4 (key) + 2 (value)) = 7468 bytes
     */
