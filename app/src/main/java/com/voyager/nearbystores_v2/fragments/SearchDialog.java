...
/**
 * Created by Amine on 11/18/2017.
 */
...
public class SearchDialog extends Dialog {
    ...
    public SearchDialog(@NonNull Context context) {
       ...
       requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        final String msg = String.format(getContext().getString(R.string.settings_notification_distance_dis),val);
    ...
    public void resetSearchDialog(boolean value){
        if(value){
            val = "+"+String.valueOf(100);
            final String msg = String.format(getContext().getString(R.string.settings_notification_distance_dis),val);
            mDistanceText.setText(msg);
            mDistanceRange.setProgress(100);
