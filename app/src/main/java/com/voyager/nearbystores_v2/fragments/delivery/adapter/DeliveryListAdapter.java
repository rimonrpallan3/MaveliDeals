...
public class DeliveryListAdapter extends RecyclerView.Adapter<DeliveryListAdapter.mViewHolder> {
    ...
    public DeliveryListAdapter(Context context, List<Offer> data) throws ParseException {
        this.data = data;
    ...
    @Override
    public void onBindViewHolder(DeliveryListAdapter.mViewHolder holder, int position) {
