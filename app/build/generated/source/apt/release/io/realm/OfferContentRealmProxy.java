...
public class OfferContentRealmProxy extends com.voyager.nearbystores_v2.classes.OfferContent
    ...
    static final class OfferContentColumnInfo extends ColumnInfo {
        ...
        long priceIndex;
        long percentIndex;
        long offerPercentIndex;
        long actualPriceIndex;
        long currencyIndex;
        ...
        OfferContentColumnInfo(OsSchemaInfo schemaInfo) {
            ...
            this.offerPercentIndex = addColumnDetails("offerPercent", objectSchemaInfo);
            this.actualPriceIndex = addColumnDetails("actualPrice", objectSchemaInfo);
        ...
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            ...
            dst.offerPercentIndex = src.offerPercentIndex;
            dst.actualPriceIndex = src.actualPriceIndex;
    ...
    private ProxyState<com.voyager.nearbystores_v2.classes.OfferContent> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.voyager.nearbystores_v2.classes.OfferContent>(this);
    ...
    @Override
    @SuppressWarnings("cast")
    public float realmGet$offerPercent() {
        proxyState.getRealm$realm().checkIfValid();
        return (float) proxyState.getRow$realm().getFloat(columnInfo.offerPercentIndex);
    }

    @Override
    public void realmSet$offerPercent(float value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            final Row row = proxyState.getRow$realm();
            row.getTable().setFloat(columnInfo.offerPercentIndex, row.getIndex(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        proxyState.getRow$realm().setFloat(columnInfo.offerPercentIndex, value);
    }
    ...
    public float realmGet$actualPrice() {
        proxyState.getRealm$realm().checkIfValid();
        return (float) proxyState.getRow$realm().getFloat(columnInfo.actualPriceIndex);
    }

    @Override
    public void realmSet$actualPrice(float value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            final Row row = proxyState.getRow$realm();
            row.getTable().setFloat(columnInfo.actualPriceIndex, row.getIndex(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        proxyState.getRow$realm().setFloat(columnInfo.actualPriceIndex, value);
    }
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("OfferContent", 7, 0);
        ...
        builder.addPersistedProperty("offerPercent", RealmFieldType.FLOAT, !Property.PRIMARY_KEY, !Property.INDEXED, Property.REQUIRED);
        builder.addPersistedProperty("actualPrice", RealmFieldType.FLOAT, !Property.PRIMARY_KEY, !Property.INDEXED, Property.REQUIRED);
    ...
    @SuppressWarnings("cast")
    public static com.voyager.nearbystores_v2.classes.OfferContent createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.voyager.nearbystores_v2.classes.OfferContent obj = null;
        if (update) {
            Table table = realm.getTable(com.voyager.nearbystores_v2.classes.OfferContent.class);
            OfferContentColumnInfo columnInfo = (OfferContentColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.OfferContent.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.OfferContent.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.OfferContentRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.OfferContent.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.OfferContentRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.OfferContent.class, json.getInt("id"), true, excludeFields);
                }
            } else {
        ...
        if (json.has("offerPercent")) {
            if (json.isNull("offerPercent")) {
                throw new IllegalArgumentException("Trying to set non-nullable field 'offerPercent' to null.");
            } else {
                objProxy.realmSet$offerPercent((float) json.getDouble("offerPercent"));
            }
        }
        if (json.has("actualPrice")) {
            if (json.isNull("actualPrice")) {
                ...
                objProxy.realmSet$actualPrice((float) json.getDouble("actualPrice"));
            }
        }
    ...
    public static com.voyager.nearbystores_v2.classes.OfferContent createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.voyager.nearbystores_v2.classes.OfferContent obj = new com.voyager.nearbystores_v2.classes.OfferContent();
        final OfferContentRealmProxyInterface objProxy = (OfferContentRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
            ...
            } else if (name.equals("offerPercent")) {
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$offerPercent((float) reader.nextDouble());
                } else {
                    reader.skipValue();
                    throw new IllegalArgumentException("Trying to set non-nullable field 'offerPercent' to null.");
                }
                ...
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$actualPrice((float) reader.nextDouble());
                } else {
                    reader.skipValue();
                    throw new IllegalArgumentException("Trying to set non-nullable field 'actualPrice' to null.");
                }
    ...
    public static com.voyager.nearbystores_v2.classes.OfferContent copyOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.OfferContent object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.voyager.nearbystores_v2.classes.OfferContent) cachedRealmObject;
        }

        com.voyager.nearbystores_v2.classes.OfferContent realmObject = null;
    ...
    public static com.voyager.nearbystores_v2.classes.OfferContent copy(Realm realm, com.voyager.nearbystores_v2.classes.OfferContent newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.voyager.nearbystores_v2.classes.OfferContent realmObject = realm.createObjectInternal(com.voyager.nearbystores_v2.classes.OfferContent.class, ((OfferContentRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        ...
        realmObjectCopy.realmSet$offerPercent(realmObjectSource.realmGet$offerPercent());
        realmObjectCopy.realmSet$actualPrice(realmObjectSource.realmGet$actualPrice());
        realmObjectCopy.realmSet$currency(realmObjectSource.realmGet$currency());
        return realmObject;
    }

    public static long insert(Realm realm, com.voyager.nearbystores_v2.classes.OfferContent object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetFloat(tableNativePtr, columnInfo.offerPercentIndex, rowIndex, ((OfferContentRealmProxyInterface) object).realmGet$offerPercent(), false);
        Table.nativeSetFloat(tableNativePtr, columnInfo.actualPriceIndex, rowIndex, ((OfferContentRealmProxyInterface) object).realmGet$actualPrice(), false);
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        OfferContentColumnInfo columnInfo = (OfferContentColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.OfferContent.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.voyager.nearbystores_v2.classes.OfferContent object = null;
        while (objects.hasNext()) {
            object = (com.voyager.nearbystores_v2.classes.OfferContent) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.OfferContent object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.voyager.nearbystores_v2.classes.OfferContent.class);
    ...
    public static com.voyager.nearbystores_v2.classes.OfferContent createDetachedCopy(com.voyager.nearbystores_v2.classes.OfferContent realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.voyager.nearbystores_v2.classes.OfferContent unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.voyager.nearbystores_v2.classes.OfferContent();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.voyager.nearbystores_v2.classes.OfferContent) cachedObject.object;
            }
            unmanagedObject = (com.voyager.nearbystores_v2.classes.OfferContent) cachedObject.object;
        ...
        unmanagedCopy.realmSet$offerPercent(realmSource.realmGet$offerPercent());
        unmanagedCopy.realmSet$actualPrice(realmSource.realmGet$actualPrice());
        unmanagedCopy.realmSet$currency(realmSource.realmGet$currency());

        return unmanagedObject;
    }

    static com.voyager.nearbystores_v2.classes.OfferContent update(Realm realm, com.voyager.nearbystores_v2.classes.OfferContent realmObject, com.voyager.nearbystores_v2.classes.OfferContent newObject, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        realmObjectTarget.realmSet$offerPercent(realmObjectSource.realmGet$offerPercent());
        realmObjectTarget.realmSet$actualPrice(realmObjectSource.realmGet$actualPrice());
    ...
    public String toString() {
        ...
        stringBuilder.append("}");
        stringBuilder.append(",");
        stringBuilder.append("{offerPercent:");
        stringBuilder.append(realmGet$offerPercent());
        stringBuilder.append("}");
        stringBuilder.append(",");
