...
public class GuestRealmProxy extends com.voyager.nearbystores_v2.classes.Guest
    ...
    private ProxyState<com.voyager.nearbystores_v2.classes.Guest> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.voyager.nearbystores_v2.classes.Guest>(this);
    ...
    @SuppressWarnings("cast")
    public static com.voyager.nearbystores_v2.classes.Guest createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.voyager.nearbystores_v2.classes.Guest obj = null;
        if (update) {
            Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Guest.class);
            GuestColumnInfo columnInfo = (GuestColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Guest.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Guest.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.GuestRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Guest.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.GuestRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Guest.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.voyager.nearbystores_v2.classes.Guest createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.voyager.nearbystores_v2.classes.Guest obj = new com.voyager.nearbystores_v2.classes.Guest();
        final GuestRealmProxyInterface objProxy = (GuestRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.voyager.nearbystores_v2.classes.Guest copyOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Guest object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.voyager.nearbystores_v2.classes.Guest) cachedRealmObject;
        }

        com.voyager.nearbystores_v2.classes.Guest realmObject = null;
    ...
    public static com.voyager.nearbystores_v2.classes.Guest copy(Realm realm, com.voyager.nearbystores_v2.classes.Guest newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.voyager.nearbystores_v2.classes.Guest realmObject = realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Guest.class, ((GuestRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.voyager.nearbystores_v2.classes.Guest object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        GuestColumnInfo columnInfo = (GuestColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Guest.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.voyager.nearbystores_v2.classes.Guest object = null;
        while (objects.hasNext()) {
            object = (com.voyager.nearbystores_v2.classes.Guest) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Guest object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Guest.class);
    ...
    public static com.voyager.nearbystores_v2.classes.Guest createDetachedCopy(com.voyager.nearbystores_v2.classes.Guest realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.voyager.nearbystores_v2.classes.Guest unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.voyager.nearbystores_v2.classes.Guest();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.voyager.nearbystores_v2.classes.Guest) cachedObject.object;
            }
            unmanagedObject = (com.voyager.nearbystores_v2.classes.Guest) cachedObject.object;
    ...
    static com.voyager.nearbystores_v2.classes.Guest update(Realm realm, com.voyager.nearbystores_v2.classes.Guest realmObject, com.voyager.nearbystores_v2.classes.Guest newObject, Map<RealmModel, RealmObjectProxy> cache) {
