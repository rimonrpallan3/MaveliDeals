...
public class ImagesRealmProxy extends com.voyager.nearbystores_v2.classes.Images
    ...
    private ProxyState<com.voyager.nearbystores_v2.classes.Images> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.voyager.nearbystores_v2.classes.Images>(this);
    ...
    @SuppressWarnings("cast")
    public static com.voyager.nearbystores_v2.classes.Images createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.voyager.nearbystores_v2.classes.Images obj = null;
        if (update) {
            Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Images.class);
            ImagesColumnInfo columnInfo = (ImagesColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Images.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Images.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.ImagesRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Images.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.ImagesRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Images.class, json.getString("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.voyager.nearbystores_v2.classes.Images createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.voyager.nearbystores_v2.classes.Images obj = new com.voyager.nearbystores_v2.classes.Images();
        final ImagesRealmProxyInterface objProxy = (ImagesRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.voyager.nearbystores_v2.classes.Images copyOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Images object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.voyager.nearbystores_v2.classes.Images) cachedRealmObject;
        }

        com.voyager.nearbystores_v2.classes.Images realmObject = null;
    ...
    public static com.voyager.nearbystores_v2.classes.Images copy(Realm realm, com.voyager.nearbystores_v2.classes.Images newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.voyager.nearbystores_v2.classes.Images realmObject = realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Images.class, ((ImagesRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.voyager.nearbystores_v2.classes.Images object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        ImagesColumnInfo columnInfo = (ImagesColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Images.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.voyager.nearbystores_v2.classes.Images object = null;
        while (objects.hasNext()) {
            object = (com.voyager.nearbystores_v2.classes.Images) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Images object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Images.class);
    ...
    public static com.voyager.nearbystores_v2.classes.Images createDetachedCopy(com.voyager.nearbystores_v2.classes.Images realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.voyager.nearbystores_v2.classes.Images unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.voyager.nearbystores_v2.classes.Images();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.voyager.nearbystores_v2.classes.Images) cachedObject.object;
            }
            unmanagedObject = (com.voyager.nearbystores_v2.classes.Images) cachedObject.object;
    ...
    static com.voyager.nearbystores_v2.classes.Images update(Realm realm, com.voyager.nearbystores_v2.classes.Images realmObject, com.voyager.nearbystores_v2.classes.Images newObject, Map<RealmModel, RealmObjectProxy> cache) {
