...
public class UserRealmProxy extends com.voyager.nearbystores_v2.classes.User
    ...
    private ProxyState<com.voyager.nearbystores_v2.classes.User> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.voyager.nearbystores_v2.classes.User>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("User", 23, 0);
    ...
    @SuppressWarnings("cast")
    public static com.voyager.nearbystores_v2.classes.User createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.voyager.nearbystores_v2.classes.User obj = null;
        if (update) {
            Table table = realm.getTable(com.voyager.nearbystores_v2.classes.User.class);
            UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.User.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.User.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.UserRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.User.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.UserRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.User.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.voyager.nearbystores_v2.classes.User createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.voyager.nearbystores_v2.classes.User obj = new com.voyager.nearbystores_v2.classes.User();
        final UserRealmProxyInterface objProxy = (UserRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.voyager.nearbystores_v2.classes.User copyOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.User object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.voyager.nearbystores_v2.classes.User) cachedRealmObject;
        }

        com.voyager.nearbystores_v2.classes.User realmObject = null;
    ...
    public static com.voyager.nearbystores_v2.classes.User copy(Realm realm, com.voyager.nearbystores_v2.classes.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.voyager.nearbystores_v2.classes.User realmObject = realm.createObjectInternal(com.voyager.nearbystores_v2.classes.User.class, ((UserRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.voyager.nearbystores_v2.classes.User object, Map<RealmModel,Long> cache) {
        ...
        String realmGet$senderid = ((UserRealmProxyInterface) object).realmGet$senderid();
        ...
        com.voyager.nearbystores_v2.classes.Images imagesObj = ((UserRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.User.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.voyager.nearbystores_v2.classes.User object = null;
        while (objects.hasNext()) {
            object = (com.voyager.nearbystores_v2.classes.User) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.User object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.voyager.nearbystores_v2.classes.User.class);
    ...
    public static com.voyager.nearbystores_v2.classes.User createDetachedCopy(com.voyager.nearbystores_v2.classes.User realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.voyager.nearbystores_v2.classes.User unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.voyager.nearbystores_v2.classes.User();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.voyager.nearbystores_v2.classes.User) cachedObject.object;
            }
            unmanagedObject = (com.voyager.nearbystores_v2.classes.User) cachedObject.object;
    ...
    static com.voyager.nearbystores_v2.classes.User update(Realm realm, com.voyager.nearbystores_v2.classes.User realmObject, com.voyager.nearbystores_v2.classes.User newObject, Map<RealmModel, RealmObjectProxy> cache) {
