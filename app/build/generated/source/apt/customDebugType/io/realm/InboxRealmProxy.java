...
public class InboxRealmProxy extends com.voyager.nearbystores_v2.classes.Inbox
    ...
    private ProxyState<com.voyager.nearbystores_v2.classes.Inbox> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.voyager.nearbystores_v2.classes.Inbox>(this);
    ...
    @SuppressWarnings("cast")
    public static com.voyager.nearbystores_v2.classes.Inbox createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.voyager.nearbystores_v2.classes.Inbox obj = null;
        if (update) {
            Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Inbox.class);
            InboxColumnInfo columnInfo = (InboxColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Inbox.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Inbox.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("discussionId")) {
                if (json.isNull("discussionId")) {
                    obj = (io.realm.InboxRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Inbox.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.InboxRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Inbox.class, json.getString("discussionId"), true, excludeFields);
                }
            } else {
    ...
    public static com.voyager.nearbystores_v2.classes.Inbox createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.voyager.nearbystores_v2.classes.Inbox obj = new com.voyager.nearbystores_v2.classes.Inbox();
        final InboxRealmProxyInterface objProxy = (InboxRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.voyager.nearbystores_v2.classes.Inbox copyOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Inbox object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.voyager.nearbystores_v2.classes.Inbox) cachedRealmObject;
        }

        com.voyager.nearbystores_v2.classes.Inbox realmObject = null;
    ...
    public static com.voyager.nearbystores_v2.classes.Inbox copy(Realm realm, com.voyager.nearbystores_v2.classes.Inbox newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.voyager.nearbystores_v2.classes.Inbox realmObject = realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Inbox.class, ((InboxRealmProxyInterface) newObject).realmGet$discussionId(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.voyager.nearbystores_v2.classes.Inbox object, Map<RealmModel,Long> cache) {
        ...
        com.voyager.nearbystores_v2.classes.User senderUserObj = ((InboxRealmProxyInterface) object).realmGet$senderUser();
        if (senderUserObj != null) {
        ...
        RealmList<com.voyager.nearbystores_v2.classes.Message> messagesList = ((InboxRealmProxyInterface) object).realmGet$messages();
        if (messagesList != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        InboxColumnInfo columnInfo = (InboxColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Inbox.class);
        long pkColumnIndex = columnInfo.discussionIdIndex;
        com.voyager.nearbystores_v2.classes.Inbox object = null;
        while (objects.hasNext()) {
            object = (com.voyager.nearbystores_v2.classes.Inbox) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Inbox object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Inbox.class);
    ...
    public static com.voyager.nearbystores_v2.classes.Inbox createDetachedCopy(com.voyager.nearbystores_v2.classes.Inbox realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.voyager.nearbystores_v2.classes.Inbox unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.voyager.nearbystores_v2.classes.Inbox();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.voyager.nearbystores_v2.classes.Inbox) cachedObject.object;
            }
            unmanagedObject = (com.voyager.nearbystores_v2.classes.Inbox) cachedObject.object;
    ...
    static com.voyager.nearbystores_v2.classes.Inbox update(Realm realm, com.voyager.nearbystores_v2.classes.Inbox realmObject, com.voyager.nearbystores_v2.classes.Inbox newObject, Map<RealmModel, RealmObjectProxy> cache) {
