...
public class DiscussionRealmProxy extends com.voyager.nearbystores_v2.classes.Discussion
    ...
    private ProxyState<com.voyager.nearbystores_v2.classes.Discussion> proxyState;
    private RealmList<com.voyager.nearbystores_v2.classes.Message> messagesRealmList;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.voyager.nearbystores_v2.classes.Discussion>(this);
    ...
    public com.voyager.nearbystores_v2.classes.User realmGet$senderUser() {
        ...
        return proxyState.getRealm$realm().get(com.voyager.nearbystores_v2.classes.User.class, proxyState.getRow$realm().getLink(columnInfo.senderUserIndex), false, Collections.<String>emptyList());
    }
    ...
    public RealmList<com.voyager.nearbystores_v2.classes.Message> realmGet$messages() {
        ...
        if (messagesRealmList != null) {
            ...
            messagesRealmList = new RealmList<com.voyager.nearbystores_v2.classes.Message>(com.voyager.nearbystores_v2.classes.Message.class, osList, proxyState.getRealm$realm());
            return messagesRealmList;
        }
    }
    ...
    public void realmSet$messages(RealmList<com.voyager.nearbystores_v2.classes.Message> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.voyager.nearbystores_v2.classes.Message> original = value;
                value = new RealmList<com.voyager.nearbystores_v2.classes.Message>();
                for (com.voyager.nearbystores_v2.classes.Message item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.voyager.nearbystores_v2.classes.Message linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static com.voyager.nearbystores_v2.classes.Discussion createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.voyager.nearbystores_v2.classes.Discussion obj = null;
        if (update) {
            Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Discussion.class);
            DiscussionColumnInfo columnInfo = (DiscussionColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Discussion.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Discussion.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("discussionId")) {
                if (json.isNull("discussionId")) {
                    obj = (io.realm.DiscussionRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Discussion.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.DiscussionRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Discussion.class, json.getInt("discussionId"), true, excludeFields);
                }
            } else {
        ...
        if (json.has("senderUser")) {
            if (json.isNull("senderUser")) {
                ...
                com.voyager.nearbystores_v2.classes.User senderUserObj = UserRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("senderUser"), update);
        ...
        if (json.has("messages")) {
            if (json.isNull("messages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.voyager.nearbystores_v2.classes.Message item = MessageRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.voyager.nearbystores_v2.classes.Discussion createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.voyager.nearbystores_v2.classes.Discussion obj = new com.voyager.nearbystores_v2.classes.Discussion();
        final DiscussionRealmProxyInterface objProxy = (DiscussionRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.voyager.nearbystores_v2.classes.User senderUserObj = UserRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$senderUser(senderUserObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$messages(new RealmList<com.voyager.nearbystores_v2.classes.Message>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.voyager.nearbystores_v2.classes.Message item = MessageRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$messages().add(item);
                    }
                    reader.endArray();
                }
    ...
    public static com.voyager.nearbystores_v2.classes.Discussion copyOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Discussion object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.voyager.nearbystores_v2.classes.Discussion) cachedRealmObject;
        }

        com.voyager.nearbystores_v2.classes.Discussion realmObject = null;
    ...
    public static com.voyager.nearbystores_v2.classes.Discussion copy(Realm realm, com.voyager.nearbystores_v2.classes.Discussion newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.voyager.nearbystores_v2.classes.Discussion realmObject = realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Discussion.class, ((DiscussionRealmProxyInterface) newObject).realmGet$discussionId(), false, Collections.<String>emptyList());
        ...
        com.voyager.nearbystores_v2.classes.User senderUserObj = realmObjectSource.realmGet$senderUser();
        if (senderUserObj == null) {
            realmObjectCopy.realmSet$senderUser(null);
        } else {
            com.voyager.nearbystores_v2.classes.User cachesenderUser = (com.voyager.nearbystores_v2.classes.User) cache.get(senderUserObj);
        ...
        RealmList<com.voyager.nearbystores_v2.classes.Message> messagesList = realmObjectSource.realmGet$messages();
        if (messagesList != null) {
            RealmList<com.voyager.nearbystores_v2.classes.Message> messagesRealmList = realmObjectCopy.realmGet$messages();
            messagesRealmList.clear();
            for (int i = 0; i < messagesList.size(); i++) {
                com.voyager.nearbystores_v2.classes.Message messagesItem = messagesList.get(i);
                com.voyager.nearbystores_v2.classes.Message cachemessages = (com.voyager.nearbystores_v2.classes.Message) cache.get(messagesItem);
    ...
    public static long insert(Realm realm, com.voyager.nearbystores_v2.classes.Discussion object, Map<RealmModel,Long> cache) {
        ...
        com.voyager.nearbystores_v2.classes.User senderUserObj = ((DiscussionRealmProxyInterface) object).realmGet$senderUser();
        if (senderUserObj != null) {
        ...
        RealmList<com.voyager.nearbystores_v2.classes.Message> messagesList = ((DiscussionRealmProxyInterface) object).realmGet$messages();
        if (messagesList != null) {
            OsList messagesOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.messagesIndex);
            for (com.voyager.nearbystores_v2.classes.Message messagesItem : messagesList) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        DiscussionColumnInfo columnInfo = (DiscussionColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Discussion.class);
        long pkColumnIndex = columnInfo.discussionIdIndex;
        com.voyager.nearbystores_v2.classes.Discussion object = null;
        while (objects.hasNext()) {
            object = (com.voyager.nearbystores_v2.classes.Discussion) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Discussion object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Discussion.class);
    ...
    public static com.voyager.nearbystores_v2.classes.Discussion createDetachedCopy(com.voyager.nearbystores_v2.classes.Discussion realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.voyager.nearbystores_v2.classes.Discussion unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.voyager.nearbystores_v2.classes.Discussion();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.voyager.nearbystores_v2.classes.Discussion) cachedObject.object;
            }
            unmanagedObject = (com.voyager.nearbystores_v2.classes.Discussion) cachedObject.object;
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.voyager.nearbystores_v2.classes.Message> managedmessagesList = realmSource.realmGet$messages();
            RealmList<com.voyager.nearbystores_v2.classes.Message> unmanagedmessagesList = new RealmList<com.voyager.nearbystores_v2.classes.Message>();
            unmanagedCopy.realmSet$messages(unmanagedmessagesList);
            int nextDepth = currentDepth + 1;
            int size = managedmessagesList.size();
            for (int i = 0; i < size; i++) {
                com.voyager.nearbystores_v2.classes.Message item = MessageRealmProxy.createDetachedCopy(managedmessagesList.get(i), nextDepth, maxDepth, cache);
    ...
    static com.voyager.nearbystores_v2.classes.Discussion update(Realm realm, com.voyager.nearbystores_v2.classes.Discussion realmObject, com.voyager.nearbystores_v2.classes.Discussion newObject, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        RealmList<com.voyager.nearbystores_v2.classes.Message> messagesList = realmObjectSource.realmGet$messages();
        RealmList<com.voyager.nearbystores_v2.classes.Message> messagesRealmList = realmObjectTarget.realmGet$messages();
