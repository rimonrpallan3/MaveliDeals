...
public class ReviewRealmProxy extends com.voyager.nearbystores_v2.classes.Review
    ...
    private ProxyState<com.voyager.nearbystores_v2.classes.Review> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.voyager.nearbystores_v2.classes.Review>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Review", 6, 0);
    ...
    @SuppressWarnings("cast")
    public static com.voyager.nearbystores_v2.classes.Review createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.voyager.nearbystores_v2.classes.Review obj = null;
        if (update) {
            Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Review.class);
            ReviewColumnInfo columnInfo = (ReviewColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Review.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Review.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("id_rate")) {
                if (json.isNull("id_rate")) {
                    obj = (io.realm.ReviewRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Review.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.ReviewRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Review.class, json.getInt("id_rate"), true, excludeFields);
                }
            } else {
    ...
    public static com.voyager.nearbystores_v2.classes.Review createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.voyager.nearbystores_v2.classes.Review obj = new com.voyager.nearbystores_v2.classes.Review();
        final ReviewRealmProxyInterface objProxy = (ReviewRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.voyager.nearbystores_v2.classes.Review copyOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Review object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.voyager.nearbystores_v2.classes.Review) cachedRealmObject;
        }

        com.voyager.nearbystores_v2.classes.Review realmObject = null;
    ...
    public static com.voyager.nearbystores_v2.classes.Review copy(Realm realm, com.voyager.nearbystores_v2.classes.Review newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.voyager.nearbystores_v2.classes.Review realmObject = realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Review.class, ((ReviewRealmProxyInterface) newObject).realmGet$id_rate(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.voyager.nearbystores_v2.classes.Review object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        ReviewColumnInfo columnInfo = (ReviewColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Review.class);
        long pkColumnIndex = columnInfo.id_rateIndex;
        com.voyager.nearbystores_v2.classes.Review object = null;
        while (objects.hasNext()) {
            object = (com.voyager.nearbystores_v2.classes.Review) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Review object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Review.class);
    ...
    public static com.voyager.nearbystores_v2.classes.Review createDetachedCopy(com.voyager.nearbystores_v2.classes.Review realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.voyager.nearbystores_v2.classes.Review unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.voyager.nearbystores_v2.classes.Review();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.voyager.nearbystores_v2.classes.Review) cachedObject.object;
            }
            unmanagedObject = (com.voyager.nearbystores_v2.classes.Review) cachedObject.object;
    ...
    static com.voyager.nearbystores_v2.classes.Review update(Realm realm, com.voyager.nearbystores_v2.classes.Review realmObject, com.voyager.nearbystores_v2.classes.Review newObject, Map<RealmModel, RealmObjectProxy> cache) {
