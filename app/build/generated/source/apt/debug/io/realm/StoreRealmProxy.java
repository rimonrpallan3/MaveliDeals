...
public class StoreRealmProxy extends com.voyager.nearbystores_v2.classes.Store
    ...
    private ProxyState<com.voyager.nearbystores_v2.classes.Store> proxyState;
    private RealmList<com.voyager.nearbystores_v2.classes.Images> listImagesRealmList;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.voyager.nearbystores_v2.classes.Store>(this);
    ...
    @Override
    public com.voyager.nearbystores_v2.classes.User realmGet$user() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.userIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.voyager.nearbystores_v2.classes.User.class, proxyState.getRow$realm().getLink(columnInfo.userIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$user(com.voyager.nearbystores_v2.classes.User value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
    ...
    public RealmList<com.voyager.nearbystores_v2.classes.Images> realmGet$listImages() {
        ...
        if (listImagesRealmList != null) {
            ...
            listImagesRealmList = new RealmList<com.voyager.nearbystores_v2.classes.Images>(com.voyager.nearbystores_v2.classes.Images.class, osList, proxyState.getRealm$realm());
            return listImagesRealmList;
        }
    }
    ...
    public void realmSet$listImages(RealmList<com.voyager.nearbystores_v2.classes.Images> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.voyager.nearbystores_v2.classes.Images> original = value;
                value = new RealmList<com.voyager.nearbystores_v2.classes.Images>();
                for (com.voyager.nearbystores_v2.classes.Images item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.voyager.nearbystores_v2.classes.Images linkedObject = value.get(i);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Store", 23, 0);
        ...
        builder.addPersistedProperty("saved", RealmFieldType.BOOLEAN, !Property.PRIMARY_KEY, !Property.INDEXED, Property.REQUIRED);
    ...
    @SuppressWarnings("cast")
    public static com.voyager.nearbystores_v2.classes.Store createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(3);
        com.voyager.nearbystores_v2.classes.Store obj = null;
        if (update) {
            Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Store.class);
            StoreColumnInfo columnInfo = (StoreColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Store.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Store.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.StoreRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Store.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.StoreRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Store.class, json.getInt("id"), true, excludeFields);
                }
            } else {
        ...
        if (json.has("user")) {
            if (json.isNull("user")) {
                ...
                com.voyager.nearbystores_v2.classes.User userObj = UserRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("user"), update);
        ...
        if (json.has("listImages")) {
            if (json.isNull("listImages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.voyager.nearbystores_v2.classes.Images item = ImagesRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
        ...
        if (json.has("saved")) {
            if (json.isNull("saved")) {
                ...
                objProxy.realmSet$saved((boolean) json.getBoolean("saved"));
            }
        }
    ...
    public static com.voyager.nearbystores_v2.classes.Store createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.voyager.nearbystores_v2.classes.Store obj = new com.voyager.nearbystores_v2.classes.Store();
        final StoreRealmProxyInterface objProxy = (StoreRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.voyager.nearbystores_v2.classes.User userObj = UserRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$user(userObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$listImages(new RealmList<com.voyager.nearbystores_v2.classes.Images>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.voyager.nearbystores_v2.classes.Images item = ImagesRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$listImages().add(item);
                    }
                    reader.endArray();
                }
                ...
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$saved((boolean) reader.nextBoolean());
                } else {
                    reader.skipValue();
                    throw new IllegalArgumentException("Trying to set non-nullable field 'saved' to null.");
                }
    ...
    public static com.voyager.nearbystores_v2.classes.Store copyOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Store object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.voyager.nearbystores_v2.classes.Store) cachedRealmObject;
        }

        com.voyager.nearbystores_v2.classes.Store realmObject = null;
    ...
    public static com.voyager.nearbystores_v2.classes.Store copy(Realm realm, com.voyager.nearbystores_v2.classes.Store newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.voyager.nearbystores_v2.classes.Store realmObject = realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Store.class, ((StoreRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        ...
        com.voyager.nearbystores_v2.classes.User userObj = realmObjectSource.realmGet$user();
        if (userObj == null) {
            realmObjectCopy.realmSet$user(null);
        } else {
            com.voyager.nearbystores_v2.classes.User cacheuser = (com.voyager.nearbystores_v2.classes.User) cache.get(userObj);
            if (cacheuser != null) {
        ...
        RealmList<com.voyager.nearbystores_v2.classes.Images> listImagesList = realmObjectSource.realmGet$listImages();
        if (listImagesList != null) {
            RealmList<com.voyager.nearbystores_v2.classes.Images> listImagesRealmList = realmObjectCopy.realmGet$listImages();
            listImagesRealmList.clear();
            for (int i = 0; i < listImagesList.size(); i++) {
                com.voyager.nearbystores_v2.classes.Images listImagesItem = listImagesList.get(i);
                com.voyager.nearbystores_v2.classes.Images cachelistImages = (com.voyager.nearbystores_v2.classes.Images) cache.get(listImagesItem);
    ...
    public static long insert(Realm realm, com.voyager.nearbystores_v2.classes.Store object, Map<RealmModel,Long> cache) {
        ...
        com.voyager.nearbystores_v2.classes.Images imagesObj = ((StoreRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
        ...
        com.voyager.nearbystores_v2.classes.User userObj = ((StoreRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
        ...
        RealmList<com.voyager.nearbystores_v2.classes.Images> listImagesList = ((StoreRealmProxyInterface) object).realmGet$listImages();
        if (listImagesList != null) {
            OsList listImagesOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.listImagesIndex);
            for (com.voyager.nearbystores_v2.classes.Images listImagesItem : listImagesList) {
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.savedIndex, rowIndex, ((StoreRealmProxyInterface) object).realmGet$saved(), false);
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        StoreColumnInfo columnInfo = (StoreColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Store.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.voyager.nearbystores_v2.classes.Store object = null;
        while (objects.hasNext()) {
            object = (com.voyager.nearbystores_v2.classes.Store) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Store object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Store.class);
    ...
    public static com.voyager.nearbystores_v2.classes.Store createDetachedCopy(com.voyager.nearbystores_v2.classes.Store realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.voyager.nearbystores_v2.classes.Store unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.voyager.nearbystores_v2.classes.Store();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.voyager.nearbystores_v2.classes.Store) cachedObject.object;
            }
            unmanagedObject = (com.voyager.nearbystores_v2.classes.Store) cachedObject.object;
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.voyager.nearbystores_v2.classes.Images> managedlistImagesList = realmSource.realmGet$listImages();
            RealmList<com.voyager.nearbystores_v2.classes.Images> unmanagedlistImagesList = new RealmList<com.voyager.nearbystores_v2.classes.Images>();
            unmanagedCopy.realmSet$listImages(unmanagedlistImagesList);
            int nextDepth = currentDepth + 1;
            int size = managedlistImagesList.size();
            for (int i = 0; i < size; i++) {
                com.voyager.nearbystores_v2.classes.Images item = ImagesRealmProxy.createDetachedCopy(managedlistImagesList.get(i), nextDepth, maxDepth, cache);
    ...
    static com.voyager.nearbystores_v2.classes.Store update(Realm realm, com.voyager.nearbystores_v2.classes.Store realmObject, com.voyager.nearbystores_v2.classes.Store newObject, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        RealmList<com.voyager.nearbystores_v2.classes.Images> listImagesList = realmObjectSource.realmGet$listImages();
        RealmList<com.voyager.nearbystores_v2.classes.Images> listImagesRealmList = realmObjectTarget.realmGet$listImages();
