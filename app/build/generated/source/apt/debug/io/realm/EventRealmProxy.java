...
public class EventRealmProxy extends com.voyager.nearbystores_v2.classes.Event
    ...
    private ProxyState<com.voyager.nearbystores_v2.classes.Event> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.voyager.nearbystores_v2.classes.Event>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Event", 19, 0);
    ...
    @SuppressWarnings("cast")
    public static com.voyager.nearbystores_v2.classes.Event createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.voyager.nearbystores_v2.classes.Event obj = null;
        if (update) {
            Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Event.class);
            EventColumnInfo columnInfo = (EventColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Event.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Event.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.EventRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Event.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.EventRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Event.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.voyager.nearbystores_v2.classes.Event createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.voyager.nearbystores_v2.classes.Event obj = new com.voyager.nearbystores_v2.classes.Event();
        final EventRealmProxyInterface objProxy = (EventRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.voyager.nearbystores_v2.classes.Event copyOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Event object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.voyager.nearbystores_v2.classes.Event) cachedRealmObject;
        }

        com.voyager.nearbystores_v2.classes.Event realmObject = null;
    ...
    public static com.voyager.nearbystores_v2.classes.Event copy(Realm realm, com.voyager.nearbystores_v2.classes.Event newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.voyager.nearbystores_v2.classes.Event realmObject = realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Event.class, ((EventRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.voyager.nearbystores_v2.classes.Event object, Map<RealmModel,Long> cache) {
        ...
        com.voyager.nearbystores_v2.classes.Images ImagesObj = ((EventRealmProxyInterface) object).realmGet$Images();
        if (ImagesObj != null) {
        ...
        RealmList<com.voyager.nearbystores_v2.classes.Images> listImagesList = ((EventRealmProxyInterface) object).realmGet$listImages();
        if (listImagesList != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        EventColumnInfo columnInfo = (EventColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Event.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.voyager.nearbystores_v2.classes.Event object = null;
        while (objects.hasNext()) {
            object = (com.voyager.nearbystores_v2.classes.Event) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Event object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Event.class);
    ...
    public static com.voyager.nearbystores_v2.classes.Event createDetachedCopy(com.voyager.nearbystores_v2.classes.Event realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.voyager.nearbystores_v2.classes.Event unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.voyager.nearbystores_v2.classes.Event();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.voyager.nearbystores_v2.classes.Event) cachedObject.object;
            }
            unmanagedObject = (com.voyager.nearbystores_v2.classes.Event) cachedObject.object;
    ...
    static com.voyager.nearbystores_v2.classes.Event update(Realm realm, com.voyager.nearbystores_v2.classes.Event realmObject, com.voyager.nearbystores_v2.classes.Event newObject, Map<RealmModel, RealmObjectProxy> cache) {
