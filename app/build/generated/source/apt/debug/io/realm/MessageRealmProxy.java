...
public class MessageRealmProxy extends com.voyager.nearbystores_v2.classes.Message
    ...
    private ProxyState<com.voyager.nearbystores_v2.classes.Message> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.voyager.nearbystores_v2.classes.Message>(this);
    ...
    @SuppressWarnings("cast")
    public static com.voyager.nearbystores_v2.classes.Message createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.voyager.nearbystores_v2.classes.Message obj = null;
        if (update) {
            Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Message.class);
            MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Message.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Message.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("messageid")) {
                if (json.isNull("messageid")) {
                    obj = (io.realm.MessageRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Message.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.MessageRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Message.class, json.getString("messageid"), true, excludeFields);
                }
            } else {
    ...
    public static com.voyager.nearbystores_v2.classes.Message createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.voyager.nearbystores_v2.classes.Message obj = new com.voyager.nearbystores_v2.classes.Message();
        final MessageRealmProxyInterface objProxy = (MessageRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.voyager.nearbystores_v2.classes.Message copyOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Message object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.voyager.nearbystores_v2.classes.Message) cachedRealmObject;
        }

        com.voyager.nearbystores_v2.classes.Message realmObject = null;
    ...
    public static com.voyager.nearbystores_v2.classes.Message copy(Realm realm, com.voyager.nearbystores_v2.classes.Message newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.voyager.nearbystores_v2.classes.Message realmObject = realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Message.class, ((MessageRealmProxyInterface) newObject).realmGet$messageid(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.voyager.nearbystores_v2.classes.Message object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Message.class);
        long pkColumnIndex = columnInfo.messageidIndex;
        com.voyager.nearbystores_v2.classes.Message object = null;
        while (objects.hasNext()) {
            object = (com.voyager.nearbystores_v2.classes.Message) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Message.class);
    ...
    public static com.voyager.nearbystores_v2.classes.Message createDetachedCopy(com.voyager.nearbystores_v2.classes.Message realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.voyager.nearbystores_v2.classes.Message unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.voyager.nearbystores_v2.classes.Message();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.voyager.nearbystores_v2.classes.Message) cachedObject.object;
            }
            unmanagedObject = (com.voyager.nearbystores_v2.classes.Message) cachedObject.object;
    ...
    static com.voyager.nearbystores_v2.classes.Message update(Realm realm, com.voyager.nearbystores_v2.classes.Message realmObject, com.voyager.nearbystores_v2.classes.Message newObject, Map<RealmModel, RealmObjectProxy> cache) {
