...
public class CategoryRealmProxy extends com.voyager.nearbystores_v2.classes.Category
    ...
    private ProxyState<com.voyager.nearbystores_v2.classes.Category> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.voyager.nearbystores_v2.classes.Category>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Category", 7, 0);
    ...
    @SuppressWarnings("cast")
    public static com.voyager.nearbystores_v2.classes.Category createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.voyager.nearbystores_v2.classes.Category obj = null;
        if (update) {
            Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Category.class);
            CategoryColumnInfo columnInfo = (CategoryColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Category.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Category.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("numCat")) {
                if (json.isNull("numCat")) {
                    obj = (io.realm.CategoryRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Category.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.CategoryRealmProxy) realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Category.class, json.getInt("numCat"), true, excludeFields);
                }
            } else {
    ...
    public static com.voyager.nearbystores_v2.classes.Category createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.voyager.nearbystores_v2.classes.Category obj = new com.voyager.nearbystores_v2.classes.Category();
        final CategoryRealmProxyInterface objProxy = (CategoryRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.voyager.nearbystores_v2.classes.Category copyOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Category object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.voyager.nearbystores_v2.classes.Category) cachedRealmObject;
        }

        com.voyager.nearbystores_v2.classes.Category realmObject = null;
    ...
    public static com.voyager.nearbystores_v2.classes.Category copy(Realm realm, com.voyager.nearbystores_v2.classes.Category newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.voyager.nearbystores_v2.classes.Category realmObject = realm.createObjectInternal(com.voyager.nearbystores_v2.classes.Category.class, ((CategoryRealmProxyInterface) newObject).realmGet$numCat(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.voyager.nearbystores_v2.classes.Category object, Map<RealmModel,Long> cache) {
        ...
        com.voyager.nearbystores_v2.classes.Images imagesObj = ((CategoryRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        CategoryColumnInfo columnInfo = (CategoryColumnInfo) realm.getSchema().getColumnInfo(com.voyager.nearbystores_v2.classes.Category.class);
        long pkColumnIndex = columnInfo.numCatIndex;
        com.voyager.nearbystores_v2.classes.Category object = null;
        while (objects.hasNext()) {
            object = (com.voyager.nearbystores_v2.classes.Category) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.voyager.nearbystores_v2.classes.Category object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.voyager.nearbystores_v2.classes.Category.class);
    ...
    public static com.voyager.nearbystores_v2.classes.Category createDetachedCopy(com.voyager.nearbystores_v2.classes.Category realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.voyager.nearbystores_v2.classes.Category unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.voyager.nearbystores_v2.classes.Category();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.voyager.nearbystores_v2.classes.Category) cachedObject.object;
            }
            unmanagedObject = (com.voyager.nearbystores_v2.classes.Category) cachedObject.object;
    ...
    static com.voyager.nearbystores_v2.classes.Category update(Realm realm, com.voyager.nearbystores_v2.classes.Category realmObject, com.voyager.nearbystores_v2.classes.Category newObject, Map<RealmModel, RealmObjectProxy> cache) {
